...
public class OfflineSpeakerDiarizationDemo {
    ...
    Step 4. Run it
        */
        ...
        String segmentationModel = "src/sherpa-onnx-pyannote-segmentation-3-0/model.onnx";
        String embeddingModel = "src/3dspeaker_speech_eres2net_base_sv_zh-cn_3dspeaker_16k.onnx";
        String waveFilename = "src/0-four-speakers-zh.wav";
...
//                        .setNumClusters(-1) // set it to -1 if you don't know the actual number
                        .setThreshold(0.5f)
                        .build();
